#21.12.2017 insert function to switch between 6.1 and future 6.2
...
images.append(["switch to V6.3", "http://pur-e2.club/OU/images/6.2"])
#images.append(["switch to V6.2", "http://pur-e2.club/OU/images/6.3"])
...
class doFlashImage(Screen):
	skin = """
	<screen position="center,center" size="720,500" title="Flash On the fly (select an image)">
		<ePixmap position="0,460"   zPosition="1" size="180,40" halign="center" pixmap="skin_default/buttons/red.png" transparent="1" alphatest="on" />
		<ePixmap position="180,460" zPosition="1" size="180,40" halign="center" pixmap="skin_default/buttons/green.png" transparent="1" alphatest="on" />
		<ePixmap position="360,460" zPosition="1" size="180,40" halign="center" pixmap="skin_default/buttons/yellow.png" transparent="1" alphatest="on" />
		<ePixmap position="540,460" zPosition="1" size="180,40" halign="center" pixmap="skin_default/buttons/blue.png" transparent="1" alphatest="on" />
		<widget name="key_red" position="0,460" zPosition="2" size="180,40" valign="center" halign="center" font="Regular;21" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
		<widget name="key_green" position="180,460" zPosition="2" size="180,40" valign="center" halign="center" font="Regular;21" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
		<widget name="key_yellow" position="360,460" zPosition="2" size="180,40" valign="center" halign="center" font="Regular;21" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
		<widget name="key_blue" position="540,460" zPosition="2" size="180,40" valign="center" halign="center" font="Regular;21" transparent="1" shadowColor="black" shadowOffset="-1,-1" />
		<widget name="imageList" position="10,10" zPosition="1" size="700,450" font="Regular;20" scrollbarMode="showOnDemand" transparent="1" />
	</screen>"""
	...
	def green(self):
		sel = self["imageList"].l.getCurrentSelection()
		if getBrandOEM() == "ixuss":
			self.setfeed = 'ixuss'
		elif getBrandOEM() == "vuplus":
			self.setfeed = 'vuplus'
			if getDriverDate() == '20150505' or getDriverDate() == '20151231':
				self.setfeed = 'vuf'    # Ferrari Vu
		elif getBrandOEM() == "odin":
			self.setfeed = 'odin'
		elif getMachineBrand() == "Octagon":
			self.setfeed = 'octagon'
		elif getMachineBrand() == "MK-Digital":
			self.setfeed = 'mkdigital'
		elif getBrandOEM() == "gigablue":
			self.setfeed = 'gigablue'
		elif getBrandOEM() == "xtrend":
			self.setfeed = 'xtrend'
		elif getBrandOEM() == "ebox":
			self.setfeed = 'mixos'
		elif getBoxType() == "triplex" or getBoxType() == "axodin" or getBoxType() == "quadbox2400" or getBoxType() == "ax51":
			self.setfeed = 'ax'
		else:
			self.setfeed = getBrandOEM()
		if sel == None:
			print"Nothing to select !!"
			return
		...
		self.hide()
		if self.Online:
			url = self.feedurl + "/" + self.setfeed + "/" + sel
	...
	def layoutFinished(self):
		...
		if self.Online:
			...
			url = '%s/%s/%s.txt' % (self.feedurl, self.setfeed, box)
