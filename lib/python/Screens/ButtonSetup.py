...
def getButtonSetupKeys():
	return [(_("Red"), "red", ""),
		...
		(_("Backspace long"), "backspace_long", ""),
		...
		(_("F8 long"), "f8_long", ""),
		(_("USB/close"), "close", ""),
		(_("USB/close long"), "close_long", ""),
		(_("PIP"), "f6", ""),
		(_("PIP long"), "f6_long", ""),
		(_("Page up"), "pageup", ""),
		(_("Page down"), "pagedown", ""),
		(_("Mode"), "mode", ""),
		(_("Mode long"), "mode_long", ""),]
...
def getButtonSetupFunctions():
	...
	ButtonSetupFunctions.append((_("OScam Info"), "Infobar/openOScamInfo", "InfoBar"))
	ButtonSetupFunctions.append((_("Toggle video policy"), "Infobar/ToggleVideo", "InfoBar"))
	ButtonSetupFunctions.append((_("Sleep timer"), "Infobar/SleepTimer", "InfoBar"))
	ButtonSetupFunctions.append((_("CAM manager"), "Infobar/CAMmanager", "InfoBar"))
	ButtonSetupFunctions.append((_("CAM restart"), "Infobar/CAMrestart", "InfoBar"))
	ButtonSetupFunctions.append((_("Device manager"), "Infobar/PBdevman", "InfoBar"))
	ButtonSetupFunctions.append((_("Media Player2"), "Infobar/MP2", "InfoBar"))
