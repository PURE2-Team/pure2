	...
	def setItemsPerPage(self):
		if self.type == EPG_TYPE_GRAPH or self.type == EPG_TYPE_INFOBARGRAPH:
			...
			if self.listHeight > 0:
				...
				# SingleEPG - for Estuary ... PBnigma/PurE2 and OE-A based
				# if resolveFilename(SCOPE_ACTIVE_SKIN).find('Estuary') != -1:
					# itemHeight = 48
					# self.eventFontSizeSingle = 27
				# Cut here
			else:
				itemHeight = 32
			if itemHeight < 15:
			...
			if self.listHeight > 0:
				...
				# MultiEPG - for Estuary ... PBnigma/PurE2 and OE-A based
				# if resolveFilename(SCOPE_ACTIVE_SKIN).find('Estuary') != -1:
					# itemHeight = 48
					# self.eventFontSizeSingle = 27
				# Cut here
