...
#new version of EPG Import making trouble, so this will fix the thing 
selectionpng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_ACTIVE_SKIN, "icons/lock_on.png"))
