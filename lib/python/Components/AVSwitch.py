...
class AVSwitch:
	...
	if (about.getChipSetString() in ('7366', '7376', '5272s', '7444', '7445', '7445s')):
		modes["HDMI"] = ["1080p", "720p", "2160p", "1080i", "576p", "576i", "480p", "480i"]
		widescreen_modes = {"1080p", "720p", "1080i", "2160p"}
	elif (about.getChipSetString() in ('7252', '7251', '7251S', '7252S', '7251s', '7252s', '72604', '7444s', '3798mv200', '3798cv200', 'hi3798mv200', 'hi3798cv200')):
		modes["HDMI"] = ["1080p", "720p", "2160p", "2160p30", "1080i", "576p", "576i", "480p", "480i"]
		...
		modes["HDMI"] = ["1080p", "720p", "1080i", "576p", "576i", "480p", "480i"]
